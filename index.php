...
<?php
echo "<br>Your insert is: ".$_POST["cnp"];
...
//check inserted value before verification
if(empty($cnp))
...
echo "<br>Please insert 13 numeric characters. You inserted ".strlen($cnp)." characters";
else
{
    // test CNP number
    ...
    echo "<br><b> Verification Started </b>";
    ...
    if($Modulo==$last_char)
    echo "<br><br><b>CNP is VALID";
    else
    echo "<br><br><b>CNP is INVALID";
